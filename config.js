...
(function loadStableWorkBoard() {
  ...
  function setVersion() {
    ...
    if (window.WORK_BOARD_RELEASE_VERSION !== VERSION) window.WORK_BOARD_RELEASE_VERSION = VERSION;
    if (window.WORK_BOARD_VERSION !== VERSION) window.WORK_BOARD_VERSION = VERSION;
