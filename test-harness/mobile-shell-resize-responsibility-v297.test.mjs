...
test('Ver.297+ keeps release and responsibility baseline aligned after 269', () => {
...
test('Ver.297 startup ownership and one-shot global click binding remain durable', () => {
