...
test('Ver.196 manifest is the release-version source and preserves foundation script order', () => {
  assert.match(manifest, /version:\s*["']196["']/);
  assert.match(manifest, /const VERSION = ["']196["']/);
