...
const cases = [
  ...
  { spec: 'tests/firebase-emulator-workflow-v148-audit-v248.spec.mjs', grep: 'stale dependency edit overwrites a newer remote dependency' },
  { spec: 'tests/firebase-emulator-workflow-v148-audit-v248.spec.mjs', grep: 'stale saved view can replace a newer server view' },
  { spec: 'tests/firebase-emulator-workflow-v148-audit-v248.spec.mjs', grep: 'stale relation edit removes a newer remote peer' },
  { spec: 'tests/firebase-emulator-workflow-v148-audit-v248.spec.mjs', grep: 'relation writer does not repair a reverse-only orphan edge' },
