...
const cases = [
  ...
  { spec: 'tests/firebase-emulator-workflow-audit-v245.spec.mjs', grep: 'inherited dependency writer touches workflowV148 only' },
  { spec: 'tests/firebase-emulator-workflow-audit-v245.spec.mjs', grep: 'current V152 reminder clear can delete a concurrent remote winner' },
