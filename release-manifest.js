// Ver.179 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV179() {
  'use strict';

  const VERSION = '179';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v179';
  ...
  guardStyle.id = 'wb-first-paint-style-v179';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V179__ = iconObserver;
...
window.WORK_BOARD_RELEASE = Object.freeze({
  ...
  dynamicStyles: ["activity-dialog-v130.css", "list-sort-v131.css", "ui-v144.css", "ui-v145.css", "ui-v146.css", "ui-v147.css", "ui-v148.css", "ui-v149.css", "ui-v150.css", "ui-v151.css", "ui-v152.css", "ui-v153.css", "ui-v154.css", "ui-v156.css", "ui-v157.css", "ui-v158.css", "ui-v159.css", "ui-v160.css", "ui-task-toolbar-v179.css", "ui-v164.css", "ui-v165.css", "ui-v167.css", "ui-v168.css", "ui-icon-system-v178.css", "ui-v173.css", "ui-v176.css"],
