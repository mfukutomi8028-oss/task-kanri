...
(function installFirstPaintGuardV226() {
  'use strict';

  const VERSION = '226';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v226';
  ...
  guardStyle.id = 'wb-first-paint-style-v226';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V226__ = iconObserver;
