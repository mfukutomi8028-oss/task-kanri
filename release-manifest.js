// Ver.214 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV214() {
  'use strict';

  const VERSION = '214';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v214';
  ...
  guardStyle.id = 'wb-first-paint-style-v214';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V214__ = iconObserver;
