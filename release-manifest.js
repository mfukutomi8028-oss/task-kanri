// Ver.262 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV262() {
  'use strict';

  const VERSION = '262';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v262';
  ...
  guardStyle.id = 'wb-first-paint-style-v262';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V262__ = iconObserver;
