// Ver.232 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV232() {
  'use strict';

  const VERSION = '232';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v232';
  ...
  guardStyle.id = 'wb-first-paint-style-v232';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V232__ = iconObserver;
...
window.WORK_BOARD_RELEASE = Object.freeze({
  ...
  requiredAssets: [
    ...
    "ui-activity-dialog-v193.css", "ui-task-list-sort-v193.css", "ui-date-segment-controls-v230.css", "ui-version-display-v232.css", "date-segment-controls-v230.js",
