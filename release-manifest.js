// Ver.209 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV209() {
  'use strict';

  const VERSION = '209';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v209';
  ...
  guardStyle.id = 'wb-first-paint-style-v209';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V209__ = iconObserver;
