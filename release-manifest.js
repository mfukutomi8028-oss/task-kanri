// Ver.172 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV172() {
  'use strict';

  const VERSION = '172';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v172';
  ...
  guardStyle.id = 'wb-first-paint-style-v172';
  ...
  // index.html の旧srcだけでなく、後から生成される業務メモの旧srcも同じ規則で即時更新する。
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V172__ = iconObserver;
  ...
  // 外部SDK障害などで load が完了しない場合でも永久に白画面にはしない。
...
window.WORK_BOARD_RELEASE = Object.freeze({
  ...
  dynamicStyles: ["activity-dialog-v130.css", "list-sort-v131.css", "ui-v144.css", "ui-v145.css", "ui-v146.css", "ui-v147.css", "ui-v148.css", "ui-v149.css", "ui-v150.css", "ui-v151.css", "ui-v152.css", "ui-v153.css", "ui-v154.css", "ui-v156.css", "ui-v157.css", "ui-v158.css", "ui-v159.css", "ui-v160.css", "ui-v162.css", "ui-v163.css", "ui-v164.css", "ui-v165.css", "ui-v167.css", "ui-v168.css", "ui-v169.css", "ui-v170.css", "ui-v171.css"],
