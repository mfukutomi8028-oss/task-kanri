// Ver.222 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV222() {
  'use strict';

  const VERSION = '222';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v222';
  ...
  guardStyle.id = 'wb-first-paint-style-v222';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V222__ = iconObserver;
