// Ver.241 のリリース正本。全配布資産と動的 loader はこの inventory を参照する。
// 初回描画では旧HTMLに残る過去アイコンや未補正UIを見せず、現行資産へ置換してから表示する。
(function installFirstPaintGuardV241() {
  'use strict';

  const VERSION = '241';
  const root = document.documentElement;
  const bootClass = 'wb-first-paint-v241';
  ...
  guardStyle.id = 'wb-first-paint-style-v241';
  ...
  window.__WB_LEGACY_ICON_OBSERVER_V241__ = iconObserver;
...
window.WORK_BOARD_RELEASE = Object.freeze({
  ...
  dynamicScripts: ["brand-v185.js", "desktop-sidebar-v181.js", "date-segment-controls-v230.js", "todo-controls-v144.js", "todo-tools-v145.js", "todo-history-v146.js", "dialog-lifecycle-v239.js", "todo-preview-v147.js", "workflow-core-v150.js", "workflow-v152.js", "dependencies-v149.js", "saved-views-v148.js", "list-column-sort-v229.js", "insights-v148.js", "comments-tabs-v149.js", "completion-unpin-v150.js", "relationships-v152.js", "reminders-v152.js", "inbox-ui-v183.js", "inbox-events-v183.js", "archive-ui-v182.js", "duplicate-merge-v182.js", "detail-layout-v154.js", "user-registration-v191.js", "comment-mentions-v191.js", "comment-reactions-v191.js", "work-features-v167.js", "work-features-ui-v190.js", "icon-system-v169.js", "bulk-actions-v174.js", "favorite-ui-v237.js"],
