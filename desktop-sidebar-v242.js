...
// The Ver.242 audit proved that the old body-wide observer only recovered a synthetic
// reinserted legacy icon. The live runtime creates the pin once, so startup/pageshow
// correction is sufficient and avoids reacting to unrelated application DOM mutations.
(function refineDesktopSidebarPinV242() {
  function apply() {
